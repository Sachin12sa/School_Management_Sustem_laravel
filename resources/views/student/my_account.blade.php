                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="name" value="{{ old('name', $getRecord->name) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="last_name" value="{{ old('last_name', $getRecord->last_name) }}"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <x-bs-date-input name="date_of_birth" id="date"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" value="{{ old('profile_pic') }}" name="profile_pic"
                                                class="form-control" />
                                            <div style="color:red">{{ $errors->first('profile_pic') }}</div>
                                            @if (!empty($getRecord->getProfile()))
                                                <img src="{{ $getRecord->getProfile() }}" style="width:65px;height:75px"
                                                    alt="">
                                            @endif
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Religion</label>
                                            <input name="religion" value="{{ old('religion', $getRecord->religion) }}"
                                                placeholder="Enter religion" class="form-control" />
                                            <div style="color:red">{{ $errors->first('religion') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Height</label>
                                            <input name="height" value="{{ old('height', $getRecord->height) }}"
                                                placeholder="Height" class="form-control" />
                                            <div style="color:red">{{ $errors->first('height') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label">Weight</label>
                                            <input name="weight" value="{{ old('weight', $getRecord->weight) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="email" value="{{ old('email', $getRecord->email) }}"
