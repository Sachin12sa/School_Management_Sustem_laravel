                    ...
                    <form method="GET" action="">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ url('parent/my_notice_board') }}" class="btn btn-outline-secondary flex-fill">
                ...
                <div class="card border-0 shadow-sm mb-3 notice-card">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <span class="badge bg-warning bg-opacity-15 text-warning px-3 py-1 flex-shrink-0 ms-3" style="font-size:.72rem;">
...
<style>
.notice-card { border-left: 4px solid rgba(255,193,7,.6) !important; transition: transform .2s ease, box-shadow .2s ease; }
