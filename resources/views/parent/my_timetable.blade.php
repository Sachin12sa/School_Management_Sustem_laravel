                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-muted small">
                                ...
                                &nbsp;&middot;&nbsp;
                                {{ $getClass->name }} &nbsp;&middot;&nbsp; {{ $getSubject->name }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @php
                                $dayColors = ['Monday'=>'primary','Tuesday'=>'info','Wednesday'=>'success','Thursday'=>'warning','Friday'=>'danger','Saturday'=>'secondary','Sunday'=>'dark'];
                                @endphp
                                @foreach($weeks as $week)
                                    @php $color = $dayColors[$week['week_name']] ?? 'secondary'; @endphp
                                    <tr>
                                        <td class="ps-4">
                                            <span class="badge bg-{{ $color }} bg-opacity-10 text-{{ $color }} px-3 py-1 fw-semibold">
                                                {{ $week['week_name'] }}
                                            </span>
                                        </td>
