    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center py-1">
                <div class="col-sm-6">
                    <h4 class="mb-0 fw-semibold"><i class="bi bi-cash-coin me-2 text-primary"></i>Fee Collection</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-3">
                <div class="card-body py-2 px-3">
                    <form method="GET" class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('accountant/fee/list') }}" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="{{ $row->amount - $row->paid_amount > 0 ? 'text-danger' : 'text-success' }}">
                                    ...
                                    <td>
                                        @if($row->status != 'paid')
                                            <a href="{{ url('accountant/fee/collect/'.$row->id) }}" class="btn btn-sm btn-success">
