                ...
                <div class="row align-items-center py-1">
                    <div class="col-sm-6">
                        <h4 class="mb-0 fw-semibold">
                            <i class="bi bi-cash-coin me-2 text-success"></i>Fee Collection
                        </h4>
                        <span class="text-muted small">View and collect student fee payments</span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6 col-xl-2">
                        <a href="{{ url('accountant/fee/list') }}" class="text-decoration-none d-block">
                            <div class="fee-stat">
                                <div class="fs-icon" style="background:#eff6ff;color:#1d4ed8;"><i
                    ...
                    <div class="col-6 col-xl-2">
                        <a href="{{ url('accountant/fee/list?status=pending') }}" class="text-decoration-none d-block">
                            <div class="fee-stat">
                                <div class="fs-icon" style="background:#fff1f2;color:#be123c;"><i
                    ...
                    <div class="col-6 col-xl-2">
                        <a href="{{ url('accountant/fee/list?status=partial') }}" class="text-decoration-none d-block">
                            <div class="fee-stat">
                                <div class="fs-icon" style="background:#fefce8;color:#ca8a04;"><i
                    ...
                    <div class="col-6 col-xl-2">
                        <a href="{{ url('accountant/fee/list?status=paid') }}" class="text-decoration-none d-block">
                            <div class="fee-stat">
                                <div class="fs-icon" style="background:#dcfce7;color:#15803d;"><i
                    ...
                    <div class="col-6 col-xl-2">
                        <a href="{{ url('accountant/fee/list?status=overdue') }}" class="text-decoration-none d-block">
                            <div class="fee-stat">
                                <div class="fs-icon" style="background:#fee2e2;color:#dc2626;"><i
                                        class="bi bi-alarm-fill"></i></div>
                                <div>
                ...
                <div class="filter-card">
                    <form method="GET" class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="student_id" id="studentFilter" class="form-select form-select-sm">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ url('accountant/fee/list') }}" class="btn btn-outline-secondary btn-sm"
                                title="Reset">
                            ...
                            <tbody>
                                @forelse($getRecord as $i => $row)
                                    ...
                                    <tr
                                        ...
                                        {{-- Student --}}
                                        <td>
                                            <a href="{{ url('accountant/fee/student/' . $row->student_id) }}"
                                                class="stu-name">
                                        ...
                                        <td>
                                            @if ($row->status === 'paid')
                                                <span class="status-badge sb-paid"><i class="bi bi-check-circle-fill"></i>
                                                    Paid</span>
                                            @elseif($row->status === 'partial')
                                                <span class="status-badge sb-partial"><i class="bi bi-clock-history"></i>
                                                    Partial</span>
                                            @else
                                                ...
                                                @if ($isOverdue)
                                                    <span class="status-badge"
                                                        style="background:#fee2e2;color:#dc2626;margin-top:2px;">
                                        ...
                                        {{-- Actions (collect + ledger only — no edit/delete for accountant) --}}
                                        <td>
                                            <div class="d-flex gap-1 flex-wrap">
                                                ...
                                                @if ($row->status !== 'paid')
                                                    <a href="{{ url('accountant/fee/collect/' . $row->id) }}"
...
@section('script')
    <script>
        ...
        // Snapshot all student & section options on page load (before any DOM mutation)
        const allStudentOptions = [...studentFilter.options].map(opt => ({
            value: opt.value,
            text: opt.text,
            cls: opt.dataset.class ?? '',
        }));

        const allSectionOptions = [...sectionFilter.options].map(opt => ({
            value: opt.value,
            text: opt.text,
            cls: opt.dataset.class ?? '',
        }));

        // ── Filter section dropdown by class ──────────────────────────────────
        function filterSections(clsId) {
            const current = sectionFilter.value;
            sectionFilter.innerHTML = '<option value="">All Sections</option>';
            allSectionOptions.forEach(s => {
                if (!s.value) return;
        ...
        // ── Filter student dropdown by class ──────────────────────────────────
        ...
        // ── On class change — reset section & student, then re-filter ─────────
        ...
        // ── On page load — re-apply filters from URL query params ─────────────
        (function init() {
