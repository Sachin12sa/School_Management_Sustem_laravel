            ...
            <div class="container-fluid">
                <div class="row align-items-center py-1">
                    ...
                    <div class="col-sm-6 text-sm-end d-flex gap-2 justify-content-sm-end flex-wrap">
                        <a href="{{ url('accountant/fee/invoice/' . $student->id) }}" class="btn btn-success btn-sm"
                            target="_blank">
                            <i class="bi bi-printer me-1"></i> Print Invoice
                        </a>
                        <a href="{{ url('accountant/fee/bulk-collect/' . $student->id) }}" class="btn btn-primary btn-sm">
