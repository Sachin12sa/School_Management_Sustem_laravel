    ...
    <main class="app-main">
        ...
        <div class="app-content">
            <div class="container-fluid">
                ...
                <form action="{{ url('librarian/library/book/edit/' . $getRecord->id) }}" method="POST"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="publish_year" class="form-control"
                                                value="{{ old('publish_year', $getRecord->publish_year) }}" min="1900"
                                                max="{{ date('Y') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Category</label>
                                            <input type="text" name="category" class="form-control"
                                                value="{{ old('category', $getRecord->category) }}" list="categoryList">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="quantity" class="form-control"
                                                value="{{ old('quantity', $getRecord->quantity) }}" min="1"
                                                required>
                                            <div class="form-text">Currently
                                                {{ $getRecord->quantity - $getRecord->available }} copies issued.</div>
                                        </div>
                                        <div class="col-12">
                            ...
                            <div class="card border-0 shadow-sm rounded-3">
                                ...
                                <div class="card-body">
                                    <select name="status" class="form-select" required>
                                        <option value="1"
                                            {{ old('status', $getRecord->status) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0"
