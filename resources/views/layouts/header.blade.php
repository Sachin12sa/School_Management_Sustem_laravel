...
<div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto align-items-center">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end shadow border-0 p-0" style="min-width:320px;">
                    <div class="dropdown-header bg-primary text-white rounded-top px-3 py-2 d-flex justify-content-between align-items-center">
                    ...
                    @php
                        $messages = [
                            ['img' => 'user1-128x128.jpg', 'name' => 'Brad Diesel',    'text' => 'Call me whenever you can...', 'time' => '4 Hours Ago',  'star' => 'text-danger'],
                            ['img' => 'user8-128x128.jpg', 'name' => 'John Pierce',    'text' => 'I got your message bro',      'time' => '6 Hours Ago',  'star' => 'text-secondary'],
                            ['img' => 'user3-128x128.jpg', 'name' => 'Nora Silvester', 'text' => 'The subject goes here',       'time' => '1 Day Ago',    'star' => 'text-warning'],
                        ];
                    @endphp
                    ...
                    @foreach($messages as $msg)
                        <a href="#" class="dropdown-item py-2 px-3 border-bottom">
                            <div class="d-flex align-items-start">
                                <img src="{{ asset('dist/assets/img/' . $msg['img']) }}"
                                     alt="{{ $msg['name'] }}"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end shadow border-0 p-0" style="min-width:300px;">
                    <div class="dropdown-header bg-warning text-dark rounded-top px-3 py-2 d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" class="dropdown-item py-2 px-3 border-bottom d-flex align-items-center">
                        <span class="me-3 bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width:36px;height:36px;">
                            <i class="bi bi-envelope-fill"></i>
                        </span>
                        <div>
                            <div class="small fw-semibold text-dark">4 new messages</div>
                            <div class="text-secondary" style="font-size:.72rem;"><i class="bi bi-clock me-1"></i>3 mins ago</div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item py-2 px-3 border-bottom d-flex align-items-center">
                        <span class="me-3 bg-success bg-opacity-10 text-success rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width:36px;height:36px;">
                            <i class="bi bi-people-fill"></i>
                        </span>
                        <div>
                            <div class="small fw-semibold text-dark">8 new enrolment requests</div>
                            <div class="text-secondary" style="font-size:.72rem;"><i class="bi bi-clock me-1"></i>12 hours ago</div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item py-2 px-3 border-bottom d-flex align-items-center">
                        <span class="me-3 bg-danger bg-opacity-10 text-danger rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width:36px;height:36px;">
                            <i class="bi bi-file-earmark-text-fill"></i>
                        </span>
                        <div>
                            <div class="small fw-semibold text-dark">3 new reports submitted</div>
                            <div class="text-secondary" style="font-size:.72rem;"><i class="bi bi-clock me-1"></i>2 days ago</div>
                        </div>
                    </a>
            ...
            <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle d-flex align-items-center gap-2 pe-0" data-bs-toggle="dropdown" href="#" role="button">
        {{-- SMALL NAV ICON --}}
     ...
     style="width:34px;height:34px;object-fit:cover;">
            <div>
                ...
                <div class="text-muted" style="font-size:.72rem;">
                    ...
                    @elseif(Auth::user()->user_type == 5) Accountant
                    @endif
                </div>
            </div>
        </div>
                    ...
                    @endphp
                    <a href="{{ url($prefix . '/account') }}" class="dropdown-item py-2 px-3 d-flex align-items-center gap-2">
                        <i class="bi bi-person-circle text-primary"></i> My Profile
                    </a>
                    <a href="{{ url($prefix . '/profile/change_password') }}" class="dropdown-item py-2 px-3 d-flex align-items-center gap-2">
                        <i class="bi bi-shield-lock text-warning"></i> Change Password
                    </a>
                    <div class="dropdown-divider my-1"></div>
                    <a href="{{ route('logout') }}" class="dropdown-item py-2 px-3 d-flex align-items-center gap-2 text-danger"
...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    ...
    <div class="sidebar-brand">
        <a href="#" class="brand-link d-flex align-items-center gap-2 px-3 py-2">
            <img src="{{ asset('dist/assets/img/school.png') }}"
   ...
   <div class="user-panel mt-3 pb-4 mb-3 mx-4 d-flex align-items-center border-bottom border-secondary">
    ...
    <div class="info ps-2">
        ...
        <a href="{{ url(Auth::user()->user_type == 1 ? 'admin/account' : '#') }}" class="d-block text-white fw-semibold small text-truncate" style="max-width:160px;">
        ...
        <nav class="mt-2 pb-3">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview">
                ...
                @if(Auth::user()->user_type == 1)
                    ...
                    <li class="nav-header text-uppercase text-secondary small px-3 mb-1" style="font-size:.67rem;letter-spacing:.08em;">Main</li>
                    ...
                    <li class="nav-header text-uppercase text-secondary small px-3 mt-2 mb-1" style="font-size:.67rem;letter-spacing:.08em;">Users</li>
                    ...
                    <li class="nav-header text-uppercase text-secondary small px-3 mt-2 mb-1" style="font-size:.67rem;letter-spacing:.08em;">Academic</li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('admin/attendance/student_attendance') }}" class="nav-link {{ request()->is('admin/attendance/student_attendance*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-calendar-check"></i><p>Student Attendance</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/attendance/attendance_report') }}" class="nav-link {{ request()->is('admin/attendance/attendance_report*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-bar-chart-line-fill"></i><p>Attendance Report</p>
                                </a>
                            </li>
                        {{-- </ul>
                    </li> --}}
                ...
                {{-- </li> --}}
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('admin/communicate/notice_board') }}" class="nav-link {{ request()->is('admin/communicate/notice_board*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-pin-angle-fill"></i><p>Notice Board</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/communicate/send_email') }}" class="nav-link {{ request()->is('admin/communicate/send_email*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-envelope-fill"></i><p>Send Email</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    {{-- Homework Submenu --}}
                    @php
                        $adminHomeworkActive = request()->is([
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('admin/homework/homework') }}" class="nav-link {{ request()->is('admin/homework/homework*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-pencil-fill"></i><p>Homework</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/homework/homework_report') }}" class="nav-link {{ request()->is('admin/homework/homework_report*') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-file-earmark-bar-graph-fill"></i><p>Homework Report</p>
                                </a>
                            </li>
                        </ul>
                    </li>

                    <li class="nav-header text-uppercase text-secondary small px-3 mt-2 mb-1" style="font-size:.67rem;letter-spacing:.08em;">Account</li>
