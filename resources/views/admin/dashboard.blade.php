...
.stat-icon {
    width: 58px; height: 58px; font-size: 1.55rem; border-radius: .6rem;
...
.action-tile {
    ...
    gap: .4rem; padding: .9rem .5rem; border-radius: .65rem; border: 1.5px solid transparent;
    text-decoration: none; color: inherit; transition: all .18s ease; background: #f8f9fa;
    text-align: center;
}
.action-tile:hover { background: #fff; transform: translateY(-2px); box-shadow: 0 .3rem .8rem rgba(0,0,0,.1); }
.action-tile i { font-size: 1.35rem; }
.action-tile span { font-size: .72rem; font-weight: 600; line-height: 1.2; }
...
/* ── Status mini-badge ──────────────────────────────── */
.hw-badge { font-size: .65rem; padding: .2em .55em; border-radius: .3rem; }
</style>
@endsection
    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            {{-- ════════════════════════════════════════════════
                 WELCOME BANNER
            ════════════════════════════════════════════════ --}}
            <div class="welcome-banner shadow-sm mb-4 px-4 py-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                    @php
                    ...
                    <p class="text-white-50 mb-0 small">
                        Here's a snapshot of your school today — {{ \Carbon\Carbon::now()->format('d F Y') }}.
                    </p>
                    ...
                    <div class="card section-card shadow-sm h-100">
                        ...
                        <div class="card-body">
                            @php
                                ...
                                $total = $total ?: 1;
                                $items = [
                                    ['label'=>'Admins',   'value'=>$TotalAdmin,   'color'=>'primary', 'icon'=>'bi-person-badge-fill'],
                                    ['label'=>'Teachers', 'value'=>$TotalTeacher, 'color'=>'success', 'icon'=>'bi-person-video3'],
                                    ['label'=>'Students', 'value'=>$TotalStudent, 'color'=>'warning', 'icon'=>'bi-people-fill'],
                                    ['label'=>'Parents',  'value'=>$TotalParent,  'color'=>'danger',  'icon'=>'bi-house-heart-fill'],
                                ];
                            @endphp
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <span class="small text-muted">
                                            <strong class="text-dark">{{ $item['value'] }}</strong> &nbsp;·&nbsp; {{ $pct }}%
                                        </span>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/admin/add') }}" class="action-tile border-primary border-opacity-25">
                                        <i class="bi bi-person-plus-fill text-primary"></i>
                                        <span>Add Admin</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/teacher/add') }}" class="action-tile border-success border-opacity-25">
                                        <i class="bi bi-person-video3 text-success"></i>
                                        <span>Add Teacher</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/student/add') }}" class="action-tile border-warning border-opacity-25">
                                        <i class="bi bi-people-fill text-warning"></i>
                                        <span>Add Student</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/parent/add') }}" class="action-tile border-danger border-opacity-25">
                                ...
                                {{-- Academic --}}
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/class/add') }}" class="action-tile border-info border-opacity-25">
                                        <i class="bi bi-building text-info"></i>
                                        <span>Add Class</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/subject/add') }}" class="action-tile border-secondary border-opacity-25">
                                        <i class="bi bi-journal-plus text-secondary"></i>
                                        <span>Add Subject</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/homework/homework/add') }}" class="action-tile border-secondary border-opacity-25">
                                        <i class="bi bi-pencil-square text-secondary"></i>
                                        <span>Add Homework</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/examination/exam/add') }}" class="action-tile border-secondary border-opacity-25" style="border-color:rgba(111,66,193,.3)!important;">
                                ...
                                {{-- Attendance & Reports --}}
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/attendance/student_attendance') }}" class="action-tile border-success border-opacity-25">
                                        <i class="bi bi-person-check-fill text-success"></i>
                                        <span>Attendance</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/attendance/attendance_report') }}" class="action-tile border-info border-opacity-25">
                                ...
                                {{-- Communicate --}}
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/communicate/notice_board/add') }}" class="action-tile border-warning border-opacity-25">
                                        <i class="bi bi-megaphone-fill text-warning"></i>
                                        <span>Post Notice</span>
                                    </a>
                                </div>
                                <div class="col-3 col-md-2">
                                    <a href="{{ url('admin/communicate/send_email') }}" class="action-tile border-primary border-opacity-25">
                                    ...
                                    @foreach($getRecentHomework as $hw)
                                        ...
                                        <div class="list-group-item list-group-item-action px-3 py-2 border-0 border-bottom">
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="activity-dot bg-secondary bg-opacity-10 text-secondary mt-1">
                                                    <i class="bi bi-journal-text" style="font-size:.8rem;"></i>
                                                </div>
                                                <div class="flex-fill min-width-0">
                                                    <div class="d-flex align-items-center justify-content-between gap-2">
                                                        <div class="fw-semibold small text-dark text-truncate" style="max-width:160px;">
                                                        ...
                                                        @else
                                                            <span class="hw-badge bg-success bg-opacity-10 text-success">Active</span>
                                                        @endif
                                                    </div>
                                                    <div class="text-muted" style="font-size:.72rem;">
                                                        <i class="bi bi-building me-1"></i>{{ $hw->class_name ?? '—' }}
                                                        &nbsp;·&nbsp;
                                                        <i class="bi bi-calendar3 me-1"></i>Due {{ date('d M', strtotime($hw->submission_date)) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card section-card shadow-sm h-100">
                        ...
                        <div class="card-body p-0">
                                    ...
                                    @foreach($getRecentNotice as $notice)
                                        <div class="list-group-item border-0 border-bottom px-3 py-2">
                                            <div class="d-flex align-items-start gap-3">
                                                ...
                                                <div class="flex-fill min-width-0">
                                                    <div class="fw-semibold small text-dark text-truncate" style="max-width:180px;">
                                                        {{ $notice->title }}
                                                    </div>
                                                    <div class="text-muted" style="font-size:.72rem;">
                                                        <i class="bi bi-calendar3 me-1"></i>{{ date('d M Y', strtotime($notice->notice_date)) }}
                                                    </div>
                                                    <div class="d-flex flex-wrap gap-1 mt-1">
                                                        @foreach($notice->getMessage as $msg)
                                                            @php
                                                                $rl = [2=>'Teacher',3=>'Student',4=>'Parent'];
                                                                $rc = [2=>'success',3=>'warning',4=>'danger'];
                                                            @endphp
                                                            @if(isset($rl[$msg->message_to]))
                                                                <span class="badge bg-{{ $rc[$msg->message_to] }} bg-opacity-10 text-{{ $rc[$msg->message_to] }}"
                            ...
                            @else
                                <div class="text-center py-5">
                                    <i class="bi bi-megaphone d-block mb-2 text-muted" style="font-size:2rem;opacity:.3;"></i>
                ...
                <div class="col-lg-3">
                    <div class="d-flex flex-column gap-3 h-100">
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted" style="font-size:.72rem;">Manage exams &amp; marks</div>
                                    </div>
                                </div>
                                <div class="d-flex gap-2">
                                    <a href="{{ url('admin/examination/exam/list') }}"
                                       class="btn btn-sm flex-fill fw-semibold text-white" style="background:#6f42c1;font-size:.72rem;">
                                        Exams
                                    </a>
                                    <a href="{{ url('admin/examination/marks_register') }}"
                                       class="btn btn-sm flex-fill btn-outline-secondary fw-semibold" style="font-size:.72rem;">
                                        Marks
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card section-card shadow-sm flex-fill">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="stat-icon" style="background:rgba(25,135,84,.1);color:#198754;width:44px;height:44px;font-size:1.2rem;">
                                        <i class="bi bi-person-check-fill"></i>
                                    </div>
                                    <div>
                                        <div class="fw-semibold small text-dark">Attendance</div>
                                        <div class="text-muted" style="font-size:.72rem;">Mark &amp; view reports</div>
                                    </div>
                                </div>
                                <div class="d-flex gap-2">
                                    <a href="{{ url('admin/attendance/student_attendance') }}"
                                       class="btn btn-sm flex-fill btn-success fw-semibold text-white" style="font-size:.72rem;">
                                        Mark
                                    </a>
                                    <a href="{{ url('admin/attendance/attendance_report') }}"
                                       class="btn btn-sm flex-fill btn-outline-success fw-semibold" style="font-size:.72rem;">
                                        Report
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="card section-card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3 text-center">
                                ...
                                @php
                                $modules = [
                                    ['icon'=>'bi-person-badge-fill', 'color'=>'primary',   'label'=>'Admins',        'url'=> url('admin/admin/list')],
                                    ['icon'=>'bi-person-video3',     'color'=>'success',   'label'=>'Teachers',      'url'=> url('admin/teacher/list')],
                                    ['icon'=>'bi-people-fill',       'color'=>'warning',   'label'=>'Students',      'url'=> url('admin/student/list')],
                                    ['icon'=>'bi-house-heart-fill',  'color'=>'danger',    'label'=>'Parents',       'url'=> url('admin/parent/list')],
                                    ['icon'=>'bi-building',          'color'=>'info',      'label'=>'Classes',       'url'=> url('admin/class/list')],
                                    ['icon'=>'bi-journal-bookmark',  'color'=>'secondary', 'label'=>'Subjects',      'url'=> url('admin/subject/list')],
                                    ['icon'=>'bi-mortarboard-fill',  'color'=>'purple',    'label'=>'Exams',         'url'=> url('admin/examination/exam/list')],
                                    ['icon'=>'bi-award-fill',        'color'=>'success',   'label'=>'Grades',        'url'=> url('admin/examination/marks_grade/list')],
                                    ['icon'=>'bi-pencil-square',     'color'=>'secondary', 'label'=>'Homework',      'url'=> url('admin/homework/homework')],
                                    ['icon'=>'bi-person-check-fill', 'color'=>'success',   'label'=>'Students Attendance',    'url'=> url('admin/attendance/student_attendance')],
                                    ['icon'=>'bi-person-check-fill', 'color'=>'success',   'label'=>'Teachers Attendance',    'url'=> url('admin/attendance/teacher_attendance')],
                                    ['icon'=>'bi-bar-chart-fill',    'color'=>'info',      'label'=>'Att. Report',   'url'=> url('admin/attendance/attendance_report')],
                                    ['icon'=>'bi-megaphone-fill',    'color'=>'warning',   'label'=>'Notice Board',  'url'=> url('admin/communicate/notice_board')],
                                    ['icon'=>'bi-envelope-fill',     'color'=>'primary',   'label'=>'Send Email',    'url'=> url('admin/communicate/send_email')],
                                    ['icon'=>'bi-calendar3-week',    'color'=>'secondary', 'label'=>'Timetable',     'url'=> url('admin/class/class_timetable')],
                                    ['icon'=>'bi-shield-lock-fill',  'color'=>'danger',    'label'=>'My Account',    'url'=> url('admin/profile/my_account')],
                                ];
                                @endphp
                                    ...
                                    <a href="{{ $mod['url'] }}"
                                       ...
                                       style="background:#f8f9fa;transition:all .18s ease;">
                                        <div class="rounded-3 d-flex align-items-center justify-content-center"
                                             ...
                                             @if($mod['color'] !== 'purple')
                                             class="bg-{{ $mod['color'] }} bg-opacity-10 text-{{ $mod['color'] }}"
                                             @endif>
                                            <i class="bi {{ $mod['icon'] }}"
                                               @if($mod['color'] === 'purple') style="color:#6f42c1;"
                                               @endif
                                            ></i>
                                        </div>
                                        <span class="text-dark fw-semibold" style="font-size:.72rem;">{{ $mod['label'] }}</span>
                                    </a>
                                </div>
                                @endforeach
