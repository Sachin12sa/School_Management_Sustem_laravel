...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <h3 class="mb-0">Edit Home Work</h3>
        </div>
    </div>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6 position-relative">
                                ...
                                <div class="input-group">
                                    <input name="homework_date" id="homework_date" value="{{ $getRecord->homework_date }}" required type="date" class="form-control" />
                            ...
                            <div class="mb-3 col-md-6 position-relative">
                                ...
                                <div class="input-group">
                                    <input name="submission_date" id="submission_date" value="{{ $getRecord->submission_date }}" required type="date" class="form-control" />
                        ...
                        <div class="mb-3">
                            ...
                            @if(!empty($getRecord->document_file))
                                <div class="mt-2">
                                    ...
                                    <a href="{{ asset('upload/homework/'.$getRecord->document_file) }}" target="_blank" class="btn btn-sm btn-info text-white ms-2">View Document</a>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" id="compose_textarea" class="form-control">{{ $getRecord->description }}</textarea>
                        </div>
                    </div>
...
$(document).ready(function() {
    $('#compose_textarea').summernote({ height: 200 });
