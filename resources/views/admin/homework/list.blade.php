        ...
        <div class="container-fluid">
            <div class="row align-items-center mb-3">
                ...
                <div class="col-sm-6 text-end">
                    <a href="{{ url('admin/homework/homework/add') }}" class="btn btn-primary">
                        + Add New Home Work
                    </a>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <a href="{{ url('admin/homework/homework') }}" class="btn btn-success">Reset</a>
                </div>
            </div>
        </div>
    </form>
                                 ...
                                 @forelse($getRecord as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('admin/homework/homework/submitted/'.$value->id) }}" class="btn btn-success btn-sm">Submitted</a>
                                            <a href="{{ url('admin/homework/homework/delete/'.$value->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
