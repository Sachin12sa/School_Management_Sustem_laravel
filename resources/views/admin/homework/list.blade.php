        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col-sm-6 text-end">
                    <a href="{{ url('admin/homework/homework/add') }}" class="btn btn-secondary px-4 shadow-sm fw-semibold">
                    ...
                    <form method="GET" action="">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ url('admin/homework/homework') }}" class="btn btn-outline-secondary flex-fill">
            ...
            <div class="card border-0 shadow-sm">
                            ...
                            <tbody>
                                ...
                                @forelse($getRecord as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="small text-dark">{{ date('d M Y', strtotime($value->homework_date)) }}</div>
                                        </td>
                                        ...
                                        <td>
                                            @if($isOverdue)
                                                <span class="badge rounded-pill bg-danger bg-opacity-10 text-danger px-2">
                                                    <i class="bi bi-circle-fill me-1" style="font-size:.4rem;vertical-align:middle;"></i>Overdue
                                                </span>
                                            @elseif($isDueSoon)
                                                <span class="badge rounded-pill bg-warning bg-opacity-10 text-warning px-2">
                                                    <i class="bi bi-circle-fill me-1" style="font-size:.4rem;vertical-align:middle;"></i>Due Soon
                                                </span>
                                            @else
                                        ...
                                        <td>
                                            <div class="small text-muted" style="max-width:150px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center py-5">
                                            ...
                                            <div class="text-muted" style="font-size:.78rem;">Add new homework to get started.</div>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="card-footer bg-white d-flex align-items-center justify-content-between py-3">
                    <span class="text-muted small">
                        Showing {{ $getRecord->firstItem() }}–{{ $getRecord->lastItem() }} of {{ $getRecord->total() }} entries
                    </span>
