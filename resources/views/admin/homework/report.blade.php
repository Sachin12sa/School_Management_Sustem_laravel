                    ...
                    <form method="GET" action="">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="from_homework_date"
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="from_submission_date"
                            ...
                            <tbody>
                                @forelse($getRecord as $value)
                                    @php
                                        ...
                                        $daysLate    = $wasLate ? (int) ceil($deadline->diffInDays($submittedAt, false)) : 0;
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <div class="small text-dark">{{ date('d M Y', strtotime($value->getHomework->homework_date)) }}</div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="small text-muted" style="max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                        ...
                                        <td class="pe-4">
                                            @if($wasLate)
                                                <span class="badge rounded-pill bg-danger bg-opacity-10 text-danger px-3 py-1">
                                                    <i class="bi bi-clock me-1"></i>Late · {{ $daysLate }} {{ $daysLate == 1 ? 'day' : 'days' }}
                                                </span>
                                            @else
