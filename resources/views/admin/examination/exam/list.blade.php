                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">
                                    <i class="bi bi-collection me-1"></i>{{ $totalExam }}
                                    {{ Str::plural('exam', $totalExam) }} total
                                </span>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span class="small">{{ $value->created_name }}
                                                        {{ $value->created_last_name }}</span>
                                                </div>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                <i class="bi bi-mortarboard d-block mb-2 text-muted"
                                                    style="font-size:2.5rem;opacity:.3;"></i>
                                                <div class="fw-semibold small text-muted">No exams found</div>
                                                <div class="text-muted" style="font-size:.78rem;">Add a new exam to get
                                                    started.</div>
                                            </td>
                                        </tr>
                                    @endforelse
