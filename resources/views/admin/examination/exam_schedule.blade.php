                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">Select an exam &amp; class to view or edit the
                                    schedule</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="GET" action="{{ url('admin/examination/exam_schedule') }}">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="class_id" id="tt_class_id" class="form-select getClass">
                                ...
                                {{-- Section filter — optional, loads on class change --}}
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold small text-secondary">
                                                ...
                                                <tr>
                                                    <td class="ps-4">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <span
                                                                class="fw-semibold small text-dark">{{ $value['subject_name'] }}</span>
                                                        </div>
                                                        <input type="hidden"
                                                    ...
                                                    <td>
                                                        <input type="date" id="date_{{ $i }}"
                                                            class="nepali-date form-control form-control-sm"
                                                            name="schedule[{{ $i }}][exam_date]"
                                                            value="{{ $value['exam_date'] }}" style="min-width:140px;">
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm"
                                                            name="schedule[{{ $i }}][start_time]"
                                                            value="{{ $value['start_time'] }}" style="min-width:110px;">
                                                    </td>
                                                    <td>
                                                        <input type="time" class="form-control form-control-sm"
                                                            name="schedule[{{ $i }}][end_time]"
                                                            value="{{ $value['end_time'] }}" style="min-width:110px;">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="schedule[{{ $i }}][room_number]"
                                                            value="{{ $value['room_number'] }}" placeholder="e.g. 101"
                                                            style="min-width:90px;">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm"
                                                            name="schedule[{{ $i }}][full_mark]"
                                                            value="{{ $value['full_mark'] }}" min="0"
                                                            placeholder="100" style="min-width:80px;">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm"
                                                            name="schedule[{{ $i }}][passing_mark]"
                                                            value="{{ $value['passing_mark'] }}" min="0"
                                                            placeholder="40" style="min-width:80px;">
                                                    </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="8" class="text-center py-5">
                                                        <i class="bi bi-calendar-x d-block mb-2 text-muted"
                                                            style="font-size:2.5rem;opacity:.3;"></i>
                                                        <div class="fw-semibold small text-muted">No subjects found for
                                                            this class</div>
                                                        <div class="text-muted" style="font-size:.78rem;">Make sure
                                                            subjects are assigned to the selected class.</div>
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
