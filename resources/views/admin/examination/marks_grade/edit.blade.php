            ...
            <div class="row align-items-center mb-4">
                <div class="col-sm-6">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="mb-0 fw-semibold text-dark">Edit Marks Grade</h4>
                ...
                <div class="col-sm-6 text-end">
                    <span class="badge bg-success bg-opacity-10 text-success px-3 py-2 fw-bold" style="font-size:.9rem;">
                        <i class="bi bi-award me-1"></i>{{ $getRecord->name }}
                    </span>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-5">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center gap-2">
                            ...
                            <h6 class="mb-0 fw-semibold">Edit Grade Details</h6>
                        </div>

                        <form method="post" action="{{ url('admin/examination/marks_grade/edit/' . $getRecord->id) }}">
                            @csrf
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="percent_to"
                                                   value="{{ old('percent_to', $getRecord->percent_to) }}" required
                                                   min="0" max="100" step="0.01"
                            ...
                            <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center py-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" class="btn btn-warning text-dark px-4 fw-semibold">
                                        <i class="bi bi-floppy-fill me-2"></i>Update Grade
                                    </button>
                                </div>
                            </div>
                        </form>
