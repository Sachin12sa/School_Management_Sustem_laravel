                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">
                                    ...
                                    <a href="{{ url('admin/parent/list') }}" class="text-muted text-decoration-none">Back to
                                        Parent List</a>
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div
                                    ...
                                    <input type="file" id="profile_pic" name="profile_pic" class="d-none"
                                        accept="image/*" onchange="previewAvatar(this, 'parentEditAvatar')">
                                    @error('profile_pic')
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="card border-0 shadow-sm">
                                ...
                                <div
                                    ...
                                    <span class="text-muted small"><i class="bi bi-info-circle me-1"></i>Fields marked
                                        <span class="text-danger">*</span> are required.</span>
