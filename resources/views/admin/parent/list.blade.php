                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div class="fw-semibold text-dark small">{{ $value->name }}
                                                            {{ $value->middle_name }} {{ $value->last_name ?? '' }}</div>
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="d-flex align-items-center justify-content-center gap-2">
                                                    <a href="{{ url('admin/parent/edit/' . $value->id) }}"
                                                        class="btn btn-sm btn-outline-primary px-3" title="Edit Parent">
                                                        <i class="bi bi-pencil-fill me-1"></i>Edit
                                                    </a>
                                                    <a href="{{ url('admin/parent/my-student/' . $value->id) }}"
                                                        class="btn btn-sm btn-outline-info px-3" title="View Children">
                                                        <i class="bi bi-people-fill me-1"></i>Students
                                                    </a>
                                                    <a href="{{ url('admin/parent/delete/' . $value->id) }}"
                                                        class="btn btn-sm btn-outline-danger px-2" title="Delete Parent"
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center py-5">
                                                <div class="text-muted">
                                                    <i class="bi bi-house-heart d-block mb-2"
