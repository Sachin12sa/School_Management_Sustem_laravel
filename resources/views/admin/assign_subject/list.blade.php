            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="mb-0 fw-semibold text-dark">Assign Subject List</h4>
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ url('admin/assign_subject/add') }}" class="btn btn-info text-white px-4 shadow-sm">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white border-bottom d-flex align-items-center gap-2 py-3">
                        ...
                        <h6 class="mb-0 fw-semibold">Filter Assigned Subjects</h6>
                    </div>
                        ...
                        <form method="get" action="">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="subject_name" value="{{ request('subject_name') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span
                                                        class="fw-semibold text-dark small">{{ $value->subject_name }}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="d-flex align-items-center justify-content-center gap-2">
                                                    ...
                                                    <a href="{{ url('admin/assign_subject/delete/' . $value->id) }}"
                                                        ...
                                                        onclick="return confirm('Are you sure you want to delete this subject assignment?')">
