...
<main class="app-main">
    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <form action="{{ url('admin/accountant/edit/' . $getRecord->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="qualification" class="form-control"
                                               value="{{ old('qualification', $getRecord->qualification) }}" placeholder="e.g. B.Com, MBS">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">Work Experience</label>
                                        <input type="text" name="work_experience" class="form-control"
                                               value="{{ old('work_experience', $getRecord->work_experience) }}" placeholder="e.g. 3 years">
                                    </div>
                                    <div class="col-md-6">
