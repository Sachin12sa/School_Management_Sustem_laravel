                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">
                                    ...
                                    {{ Str::plural('notice', $getRecord->total()) }} total
                                </span>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="small text-dark">
                                                    {{ date('d M Y', strtotime($value->notice_date)) }}</div>
                                                <div class="small text-dark"> @bsDate($value->notice_date)</div>

                                            </td>

                                            <td>
                                                <div class="small text-dark">
                                                    {{ date('d M Y', strtotime($value->publish_date)) }}</div>
                                                <div class="small text-dark"> @bsDate($value->publish_date)</div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex flex-wrap gap-1">
                                                    @foreach ($value->getMessage as $message)
                                                        ...
                                                        @if ($lbl)
                                                            <span
                                                                class="badge bg-{{ $color }} bg-opacity-10 text-{{ $color }} px-2"
                                            ...
                                            <td>
                                                ...
                                                <div class="text-muted" style="font-size:.72rem;">
                                                    {{ \Carbon\Carbon::parse($value->created_at)->format('h:i A') }}</div>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center py-5">
                                                ...
                                                <div class="text-muted" style="font-size:.78rem;">Add a new notice to get
                                                    started.</div>
                                            </td>
                                        </tr>
                                    @endforelse
