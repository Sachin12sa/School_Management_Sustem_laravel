                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="title" value="{{ old('title', $getRecord->title) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    @php
                                        $selected = old(
                                            'message_to',
                                            $getRecord->getMessage->pluck('message_to')->toArray(),
                                        );
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        @foreach ($recipients as $val => $label)
                                            <label
                                                class="recipient-label d-flex align-items-center gap-2 px-4 py-2 rounded-pill border {{ in_array($val, (array) $selected) ? 'checked-' . $colors[$val] : '' }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="message" id="compose_textarea" class="form-control" required>{{ old('message', $getRecord->message) }}</textarea>
                                </div>
