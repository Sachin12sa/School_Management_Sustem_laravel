            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white border-bottom d-flex align-items-center gap-2 py-3">
                        ...
                        <h6 class="mb-0 fw-semibold">Filter Librarians</h6>
                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-muted" style="font-size:.75rem;">Administrator
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="d-flex align-items-center justify-content-center gap-2">
                                                    <a href="{{ url('admin/admin/edit/' . $value->id) }}"
                                                        class="btn btn-sm btn-outline-primary px-3" title="Edit Admin">
                                                        <i class="bi bi-pencil-fill me-1"></i>Edit
                                                    </a>
                                                    <a href="{{ url('admin/admin/delete/' . $value->id) }}"
                                                        class="btn btn-sm btn-outline-danger px-2" title="Delete Admin"
