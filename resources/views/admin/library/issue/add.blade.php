                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Issue Date <span
                                                    class="text-danger">*</span></label>
                                            {{-- Changed type to text and added id --}}
                                            <input type="date" id="issue_date" name="issue_date"
                                                class="nepali-date form-control" value="{{ old('issue_date') }}" required
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" id="due_date" name="due_date"
                                                class="nepali-date form-control" value="{{ old('due_date') }}" required
                                                placeholder="YYYY-MM-DD" autocomplete="off">
