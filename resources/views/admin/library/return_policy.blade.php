            ...
            <div class="container-fluid">
                <div class="row align-items-center py-1">
                    ...
                    <div class="col-sm-6 text-sm-end">
                        ...
                        <a href="{{ url('admin/library/issue/list') }}" class="btn btn-primary btn-sm ms-1">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="rule-row d-flex gap-3 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small mb-0">
                                            Admin or librarian may waive a fine due to medical emergency, bereavement,
                                            or administrative error. A reason must be provided and the waiver is recorded
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card border-0 shadow-sm rounded-3 mb-3">
                            <div class="card-body p-3">
                                ...
                                @foreach ([['1', 'primary', 'bi-arrow-return-left', 'Member returns book', 'Librarian opens the issue record and clicks Return'], ['2', 'warning', 'bi-book', 'Condition is assessed', 'Select: Good / Damaged / Torn / Lost'], ['3', 'danger', 'bi-calculator', 'Charges calculated', 'Late fine + any damage charge totalled automatically'], ['4', 'secondary', 'bi-hourglass-split', 'Fine marked as Unpaid', 'Appears in Library → Fines — book return is done'], ['5', 'success', 'bi-cash-coin', 'Admin collects payment', 'Open the Unpaid fine, select method, confirm'], ['6', 'info', 'bi-check-circle', 'Fine marked as Paid', 'Record updated — member\'s account is clear']] as [$n, $col, $ic, $title, $desc])
