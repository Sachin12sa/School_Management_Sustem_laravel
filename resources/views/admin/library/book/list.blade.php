            ...
            <div class="container-fluid">
                <div class="row align-items-center py-1">
                    ...
                    <div class="col-sm-6 text-sm-end">
                        <a href="{{ url('admin/library/book/add') }}" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    @forelse($getRecord as $i => $book)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/library/book/edit/' . $book->id) }}"
                                                    class="btn btn-sm btn-outline-primary" title="Edit">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a href="{{ url('admin/library/book/delete/' . $book->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-muted py-5">
                                                ...
                                                No books found. <a href="{{ url('admin/library/book/add') }}">Add one
                                                    now</a>.
                                            </td>
                                        </tr>
                                    @endforelse
