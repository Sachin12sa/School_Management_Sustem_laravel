...
<main class="app-main">
    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <form action="{{ url('admin/library/book/add') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="category" class="form-control"
                                               value="{{ old('category') }}"
                                               placeholder="e.g. Science, Math, Fiction"
                                               list="categoryList">
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow-sm rounded-3 mb-3">
                            ...
                            <div class="card-body text-center">
                                <img id="coverPreview"
                                     src="{{ asset('dist/assets/img/default-book.png') }}"
