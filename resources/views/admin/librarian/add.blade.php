    ...
    <main class="app-main">
                ...
                <div class="row align-items-center py-1">
                    <div class="col-sm-6">
                        <h4 class="mb-0 fw-semibold text-dark">
                            <i class="bi bi-calculator-fill me-2 text-primary"></i>Add New Librarian
                        </h4>
                    </div>
                    <div class="col-sm-6 text-sm-end">
                        <a href="{{ url('admin/librarian/list') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="app-content">
            <div class="container-fluid">
                ...
                <form action="{{ url('admin/librarian/add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="marital_status" class="form-select">
                                                        <option value="">-- Select --</option>
                                                        <option value="0"
                                                            {{ old('marital_status') === '0' ? 'selected' : '' }}>Single
                                                        </option>
                                                        <option value="1"
                                                            {{ old('marital_status') === '1' ? 'selected' : '' }}>Married
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="mobile_number" class="form-control"
                                                        value="{{ old('mobile_number') }}" placeholder="98XXXXXXXX"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea name="permanent_address" class="form-control" rows="2" placeholder="Permanent address">{{ old('permanent_address') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 text-end pb-3">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bi bi-save me-1"></i> Save Librarian
                            </button>
                        </div>
