                    ...
                    <div class="card-body bg-light bg-opacity-50">
                        <form method="GET" action="{{ url('admin/attendance/student_attendance') }}">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold small text-secondary">
                                        <i class="bi bi-calendar3 me-1"></i>Attendance Date <span
                                            class="text-danger">*</span>
                                    </label>
                                    <x-bs-date-input name="attendance_date" id="attendance_date" required
                                        value="{{ Request::get('attendance_date') }}" class="form-control" />
                                </div>

                                <div class="col-md-4 d-flex gap-2" style="padding-bottom: 25px;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2">
                                                            @foreach ($options as $val => $opt)
                                                                <label
                                                                    class="att-label d-flex align-items-center gap-1 px-3 py-1 rounded-pill border"
                                                                    style="cursor:pointer;font-size:.8rem;transition:all .15s ease;"
                                                                    data-color="{{ $opt['color'] }}">
                                                                    <input type="radio" class="SaveAttendance d-none"
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="3" class="text-center py-5">
                                                    <i class="bi bi-people d-block mb-2 text-muted"
                                                        style="font-size:2.5rem;opacity:.3;"></i>
                                                    <div class="fw-semibold small text-muted">No students found in this
                                                        class</div>
                                                </td>
                                            </tr>
                                        @endif
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            $('.SaveAttendance:checked').each(function() {
                applyLabel($(this));
            });
        });
