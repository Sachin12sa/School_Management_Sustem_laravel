                            ...
                            <div class="card border-0 shadow-sm h-100">
                                ...
                                <div
                                    ...
                                    <div class="position-relative">
                                        <img id="avatarPreview" src="{{ asset('upload/profile/user.jpg') }}" alt="Preview"
                                    ...
                                    <input type="file" id="profile_pic" name="profile_pic"
                                        class="d-none @error('profile_pic') is-invalid @enderror" accept="image/*"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="marital_status"
                                                ...
                                                <option {{ old('marital_status', 1) == 1 ? 'selected' : '' }}
                                                    value="1">Unmarried</option>
                                                <option {{ old('marital_status', 1) == 0 ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <x-bs-date-input name="date_of_joining" id="date_of_joining" />
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small text-secondary">Current
                                                Address</label>
                                            <textarea name="current_address" rows="3" placeholder="Street, City, State…"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold small text-secondary">Permanent
                                                Address</label>
                                            <textarea name="permanent_address" rows="3" placeholder="Permanent address if different…"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="qualification" rows="2" placeholder="e.g. B.Ed, M.Sc…"
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label fw-semibold small text-secondary">Work
                                                Experience</label>
                                            <textarea name="work_experience" rows="2" placeholder="e.g. 5 years at City School…"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="note" rows="2" placeholder="Any additional notes…"
