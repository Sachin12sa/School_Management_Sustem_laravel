                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-muted small">
                                ...
                                <a href="{{ url('teacher/account') }}" class="text-muted text-decoration-none">Back to My Account</a>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <form method="POST" action="change_password">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary px-3" onclick="togglePassword('oldPass',this)">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary px-3" onclick="togglePassword('newPass',this)">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary px-3" onclick="togglePassword('confirmPass',this)">
                                                <i class="bi bi-eye"></i>
                                            </button>
                            ...
                            <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center py-3">
                                <a href="{{ url('teacher/account') }}" class="btn btn-outline-secondary px-4">
...
document.getElementById('newPass').addEventListener('input', function () {
    ...
    var map = [['0%','',''],['25%','bg-danger','Weak'],['50%','bg-warning','Fair'],['75%','bg-info','Good'],['100%','bg-success','Strong']];
    var m = map[score];
    var bar = document.getElementById('strength-bar');
    bar.style.width = m[0]; bar.className = 'progress-bar ' + m[1];
    var lbl = document.getElementById('strength-label');
    lbl.textContent = m[2] ? 'Strength: ' + m[2] : '';
    lbl.className   = m[1].replace('bg-','text-') + ' mt-1';
    checkMatch();
});
function checkMatch() {
    ...
    if (np === cp) { msg.textContent = '✓ Passwords match'; msg.className = 'text-success mt-1'; }
    else           { msg.textContent = '✗ Passwords do not match'; msg.className = 'text-danger mt-1'; }
}
