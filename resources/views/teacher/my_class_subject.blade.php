                                ...
                                @if($getRecord && $getRecord->count())
                                    @foreach($getRecord as $key => $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-secondary bg-opacity-10 text-secondary px-2" style="font-size:.7rem;">
                                                    {{ $value->subject_type }}
                                                </span>
                                            </td>
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge bg-danger bg-opacity-10 text-danger px-2 py-1" style="font-size:.7rem;">
                                                        <i class="bi bi-x-circle me-1"></i>No Class Today
                                                    </span>
                                                @endif
                                            </td>
                                            <td class="small text-muted">{{ $value->created_at->format('d-m-Y h:i A') }}</td>
                                            <td>
