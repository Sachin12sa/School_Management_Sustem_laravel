        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                                ...
                                <div class="row align-items-end">
                                   ...
                                   <div class="mb-3 col-md-2 position-relative">
                                    ...
                                    <div class="col-md-3" style="margin-bottom: 15px;">
                                        ...
                                        <a href="{{ url('teacher/attendance/attendance_report') }}" class="btn btn-success ms-1">Reset</a>
                                    </div>
                    ...
                    <form action="{{ url('teacher/examination/attendance_report') }}" method="post" id="SubmitMarksForm">
                        @csrf
