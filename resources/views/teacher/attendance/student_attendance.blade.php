            ...
            <div class="row mb-4">
                <div class="col-md-12">
                                ...
                                <div class="row align-items-end">
                                   ...
                                   <div class="mb-3 col-md-4 position-relative">
                                    ...
                                    <div class="col-md-4" style="padding-bottom: 15px;" >
                                        ...
                                        <a href="{{ url('teacher/attendance/student_attendance') }}" class="btn btn-success ms-1">Reset</a>
                                    </div>
                   ...
                   @if(!empty(Request::get('class_id')) && !empty(Request::get('attendance_date')))
                    ...
                    <form action="{{ url('teacher/examination/submit_marks_register') }}" method="post" id="SubmitMarksForm">
                        @csrf
...
$('.SaveAttendance').change(function () {
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('teacher/attendance/student_attendance_save') }}",
        data: {
            _token: "{{ csrf_token() }}",
