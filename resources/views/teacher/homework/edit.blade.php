                ...
                <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                                ...
                                @if(!empty($getRecord->document_file))
                                    <div class="mt-2 d-flex align-items-center gap-2">
                                        ...
                                        <a href="{{ asset('upload/homework/'.$getRecord->document_file) }}"
                                           target="_blank" class="small text-warning text-decoration-none">
                                            Current file — click to view
                                        </a>
                                        <span class="text-muted small">(uploading a new file will replace this)</span>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="message" id="compose_textarea"
                                          class="form-control @error('message') is-invalid @enderror">{{ $getRecord->description }}</textarea>
                    ...
                    <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center py-3">
                        ...
                        <button type="submit" class="btn btn-warning px-5 fw-semibold text-white">
                            <i class="bi bi-check-circle-fill me-2"></i>Update Homework
                        </button>
                    </div>
                </form>
            </div>
