                    ...
                    <form method="GET" action="">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2 d-flex gap-2">
                                ...
                                <a href="{{ url('teacher/homework/homework') }}" class="btn btn-outline-secondary flex-fill">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center py-5">
                                            ...
                                            <a href="{{ url('teacher/homework/homework/add') }}" class="btn btn-warning btn-sm mt-2">
