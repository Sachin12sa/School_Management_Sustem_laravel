                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <span class="text-muted small">Manage and track assignments</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 text-end">
                        <a href="{{ url('teacher/homework/homework/add') }}" class="btn btn-warning fw-semibold">
                            <i class="bi bi-plus-lg me-1"></i>Add New Homework
                        </a>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card border-0 shadow-sm">
                                ...
                                <tbody>
                                    @forelse($getRecord as $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($daysLeft < 0)
                                                    <span class="badge bg-danger bg-opacity-10 text-danger"
                                                        style="font-size:.62rem;">Overdue</span>
                                                @elseif($daysLeft <= 2)
                                                    <span class="badge bg-warning bg-opacity-15 text-warning"
                                                        style="font-size:.62rem;">Due Soon</span>
                                                @else
                                                    <span class="badge bg-success bg-opacity-10 text-success"
                                                        style="font-size:.62rem;">Active</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td class="small text-muted">{{ date('d-m-Y', strtotime($value->created_at)) }}
                                            </td>
                                            <td>
                                                <div class="d-flex gap-1">
                                                    ...
                                                    <a href="{{ url('teacher/homework/submitted/' . $value->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center py-5">
                                                ...
                                                <a href="{{ url('teacher/homework/homework/add') }}"
                                                    class="btn btn-warning btn-sm mt-2">
                                                    <i class="bi bi-plus me-1"></i>Add First Homework
                                                </a>
                                            </td>
                                        </tr>
                                    @endforelse
                    ...
                    <div
                        ...
                        <span class="text-muted small">{{ $getRecord->total() }}
                            {{ Str::plural('record', $getRecord->total()) }}</span>
